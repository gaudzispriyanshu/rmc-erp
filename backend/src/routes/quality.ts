...
router.post("/cube-tests", authenticate, authorize("quality:write"), validate({ body: createCubeTestSchema }), idempotency, createCubeTestController);
...
router.post("/slump-tests", authenticate, authorize("quality:write"), validate({ body: createSlumpTestSchema }), idempotency, createSlumpTestController);
...
router.post("/non-conformance", authenticate, authorize("quality:write"), validate({ body: createNonConformanceSchema }), idempotency, createNonConformanceController);
